...
<Dialog>
  <DialogTrigger>
  <Button className="mt-3 rounded-full">Book Artist</Button>
                    ...
                    <div className=' mt-3 md:mt-0'>
                        ...
                        rounded-lg p-5'>
                          {timeSlot?.map((item,index)=>(
                            ...
                            rounded-full
                            ${item.time==selectedTimeSlot&&'bg-primary text-white'}`} key={index}>{item.time}</h2>
                          ))}
                        </div>
                    </div>
                </div>
