...
export function DataTableFacetedFilter({ column, title, options, onChange }) {
  ...
  const handleSelectionChange = (optionValue) => {
    ...
    onChange(Array.from(newSelectedValues)); // Send selected values to the parent
  };
          ...
          <CommandList>
            ...
            {selectedValues.size > 0 && (
              <>
                ...
                <CommandGroup>
                  <CommandItem
                    onSelect={() => handleSelectionChange(undefined)}
