...
const ChatList = ({ setSelectedChat, chats, profilePics }) => {
    ...
    <div className="bg-gray-100 border-r border-gray-300 h-full overflow-y-auto">
      ...
      <ul>
        {sortedChats.map((chat) => {
          ...
          const artistProfile = profilePics[chat.artistId];
          const artistName = artistProfile ? artistProfile.name : chat.artistId;
          const combinedName = `${artistName} | ${chat.clientName}`;
